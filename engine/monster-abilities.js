...
cadence: 2,
telegraph: (n) => ` ${n} стреляет кристаллической иглой с нейротоксином.`,
skill: {
...
cadence: 3,
telegraph: (n) => ` ${n} опутывает тебя вязкими хитиновыми нитями.`,
skill: {
...
cadence: 2,
telegraph: (n) => ` ${n} тянется щупальцами Пустоты, поглощая всё на пути.`,
skill: {
...
cadence: 2,
telegraph: (n) => ` ${n} активирует протокол подавления цели.`,
skill: {
...
cadence: 2,
telegraph: (n) => ` ${n} переходит в режим тотального сбора — не отступит, пока один из вас не падёт.`,
skill: {
