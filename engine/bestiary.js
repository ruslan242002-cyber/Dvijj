...
/*
* ИДЕЯ НА БУДУЩЕЕ (не реализовано здесь, только заметка): "Тракт-эхо-матка"* по лору — стационарный объект, который повышает частоту засад в своём
