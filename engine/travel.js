...
*
* distance здесь — то же самое, что depth: счётчик шагов ТЕКУЩЕГО рейса* к планете, не характеристика персонажа/корабля. Обнуляется при
...
/** Настоящий (не оценочный) расход топлива на обратный путь — честно* прокатывает per-tick стоимость для каждого шага дистанции, той же
...
* текущей дистанции) встреча окажется враждебным PvP, а не обычной* пустой дорогой домой. Это и есть тот самый риск "довезти трюм живым". */
...
{ minDistance: 13, zone: 'yellow', minShipLevel: 4 },
{ minDistance: 26, zone: 'red', minShipLevel: 8 },
];
