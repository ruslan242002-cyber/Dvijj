...
const ENEMY_NAMES = {
  blue: [
    'Дрейф-обломок', 'Слабый резонанс', 'Отбившийся зонд', 'Ржавый автомат', 'Эхо-помеха',
    'Скиталец-щелкун', 'Пылевой Падальщик', 'Игольник', 'Эхоид', 'Кристаллоид',
    'Скрап-жук'
  ],
  yellow: [
    'Отголосок-падальщик', 'Резонансный хищник', 'Сбойный дрон', 'Тракт-паразит', 'Радиационный рой',
    'Гравиарх', 'Разломник', 'Тенекрыл', 'Сквернолап', 'Шлакожор',
    'Сигнальный клещ', 'Тракт-плакальщица', 'Хроножнец', 'Хитин-ткач', 'Импульсный странник'
  ],
  red: [
    'Глубинный Отголосок', 'Тракт-порождение', 'Искажённый страж', 'Голос из разлома', 'Пожиратель сигналов',
    'Пульсарид', 'Пустотный пожиратель', 'Нулевой жнец', 'Пустотный Кусач',
    'Экзо-парсер', 'Кураторский страж', 'Тракт-эхо-матка', 'Осколок Тракта'
  ]
};
...
module.exports = { rollEvent, rollLoot, generateEnemy, RESOURCES, ZONE_WEIGHTS, ENEMY_NAMES, toRoman };
