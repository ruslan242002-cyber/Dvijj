...
if (stage.reward.statPoints) { nextPlayer.statPoints = (nextPlayer.statPoints || 0) + stage.reward.statPoints; rewardLines.push(` +${stage.reward.statPoints} очков характеристик`); }
}
