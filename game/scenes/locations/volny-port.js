...
function docksScreen(player, prefixText = '') {
  ...
  return {
    reply: {
      ...
      imageKey: 'volny-port/nizhnie-doki.png',
    },
...
function upperCityScreen(player, prefixText = '') {
  ...
  return {
    reply: {
      ...
      buttons,
      imageKey: 'volny-port/verhniy-gorod.png',
    },
