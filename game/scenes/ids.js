...
const SCENES = Object.freeze({
  ...
  GUILD_UPGRADE: 'guild_upgrade',
  GUILD_PROJECTS_LIST: 'guild_projects_list',
  GUILD_PROJECT_DETAIL: 'guild_project_detail',
  GUILD_PROJECT_DONATE_CREDITS: 'guild_project_donate_credits',
  GUILD_PROJECT_DONATE_RESOURCE: 'guild_project_donate_resource',
  DICE_GAME: 'dice_game',
  TRADE_ROUTES: 'trade_routes',
  MENTOR_CLASS: 'mentor_class',
  REFORGE_PICK: 'reforge_pick',
  REFORGE_TARGET: 'reforge_target',
  BOSS_HUB: 'boss_hub',
  BOSS_COMBAT: 'boss_combat',
  RAID_LOBBY: 'raid_lobby',
  ...
  MARKET_BUY_ORDERS_HUB: 'market_buy_orders_hub',
  MARKET_BUY_ORDER_ITEM: 'market_buy_order_item',
  MARKET_BUY_ORDER_QTY: 'market_buy_order_qty',
  MARKET_BUY_ORDER_PRICE: 'market_buy_order_price',
