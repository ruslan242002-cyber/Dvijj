...
const NPCS = {
  ...
  'Терминус': ['Дрого Кейн', 'Сержант Илва', 'Механик Брок'],
  'Арсенал': ['Рен Окса', 'Оружейник Тарк', 'Разведчица Ния'],
  'Вуаль': ['Шёпот', 'Осведомитель Кес', 'Аналитик Рю']
};
...
const QUESTS = [
  ...
  { id: 'terminus_3', city: 'Терминус', minLevel: 10,
    title: 'Броня трещит',
    text: 'Механик Брок стучит по обшивке: «Латка на латке — нужна нормальная обшивка потолще. Восемь кусков, и рубеж продержится ещё лет триста».',
    objective: { type: 'deliver', resource: 'Сплавы', tier: 2, qty: 8 },
    reward: { xp: 160, credits: 180, statPoints: 1 } },
  { id: 'terminus_4', city: 'Терминус', minLevel: 15,
    title: 'Второй рубеж',
    text: 'Сержант Илва: «Разведка в открытый космос — не для слабонервных. Четыре вылазки, доклад лично мне, никакой самодеятельности».',
    objective: { type: 'explore', zone: 'red', count: 4 },
    reward: { xp: 240, credits: 260, statPoints: 2 } },
  { id: 'terminus_5', city: 'Терминус', minLevel: 20,
    title: 'Ни шагу назад',
    text: 'Дрого Кейн: «Отголоски прощупывают периметр каждую ночь. Останови восемнадцать — и они наконец перестанут пробовать».',
  ...
  { id: 'vual_3', city: 'Вуаль', minLevel: 10,
    title: 'Шёпот в помехах',
    text: 'Аналитик Рю, не поднимая головы от осциллографа: «Образцы биомассы из спорного сектора помогут расшифровать паттерн. Пять образцов, не больше и не меньше — точность важна».',
    objective: { type: 'deliver', resource: 'Биомасса', tier: 2, qty: 5 },
    reward: { xp: 160, credits: 180, statPoints: 1 } },
  { id: 'vual_4', city: 'Вуаль', minLevel: 15,
    title: 'Слепое пятно',
    text: 'Осведомитель Кес шёпотом: «В открытом космосе есть участок, который Тракт будто не хочет показывать. Пять вылазок — и мы наконец увидим, что там».',
    objective: { type: 'explore', zone: 'red', count: 5 },
    reward: { xp: 240, credits: 260, statPoints: 2 } },
  { id: 'vual_5', city: 'Вуаль', minLevel: 20,
    title: 'Чужой узор',
    text: 'Шёпот: «Шестнадцать Отголосков подряд несут один и тот же нехарактерный узор. Слишком похоже на совпадение, чтобы быть совпадением».',
