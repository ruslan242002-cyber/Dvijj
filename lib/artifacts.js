...
const QUEST_ARTIFACT_POOL = [
  ...
  { id: 'kran_worn_wrench', name: 'Разводной ключ Крана', blurb: 'Один инструмент из найденного ящика Кран оставил тебе на память — потёртая, но безотказная вещь, повидавшая больше, чем кажется на первый взгляд.', stat: 'power', bonus: 6 },
  { id: 'relay_signal_chip', name: 'Чип сигнального модуля', blurb: 'Диспетчер вынула этот чип из старого ретранслятора перед сдачей находки в архив — сувенир с того самого узла, что хранил незарегистрированный маршрут.', stat: 'reaction', bonus: 6 },
  { id: 'archive_preserved_page', name: 'Сохранённая страница', blurb: 'Айрин отдала тебе одну из найденных страниц на память — заламинировала её сама, чтобы точно пережила ещё пару десятилетий.', stat: 'mind', bonus: 6 },
  { id: 'resonance_sample_vial', name: 'Капсула с образцом резонанса', blurb: 'Ворн выделил тебе крошечный законсервированный образец из собранных данных — незаконно, наверное, зато на память о первом настоящем открытии вместе.', stat: 'mind', bonus: 7 },
];
